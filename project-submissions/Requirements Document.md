...
|--------------------|------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|---------|----------------------------------------------------------------------------------------------|
| Account Number     | Unique number representing a personal bank account                                                   | Integer                                                                                                  | 12      |                                                                                              |
| Allergen           | Details of an allergen found in an ingredient in a recipe                                            | Allergen ID + Allergen Name + Recipe ID                                                                  |         |                                                                                              |
...
| Allergen Name      | The name of a food that according to government of Canada commonly causes an allergic reaction       | String                                                                                                   | 128     |                                                                                              |
| Announcement       | A message sent out to all employees of Banter Ice Cream                                              | Announcement ID + Author + Content + 0:n {File} + 0:n {Reaction} + 0:n {View} + Timestamp                |         |                                                                                              |
| Announcement ID    | Unique identifier for an announcement                                                                | Integer                                                                                                  | 12      | system-generated sequential integer, beginning with 1                                        |
| Author             | Key to employee who is responsible for creating the object (Announcement, Message, Recipe, Schedule) | Employee ID                                                                                              |         |                                                                                              |
| Banking Info       | Information about an employee’s bank account, such that the bookkeeper can pay the employee.         | Bank Info ID + Employee ID + Transit Number + Institution Number + Account Number                        |         |                                                                                              |
...
| Contact            | Information used to contact an employee.                                                             | Email + Phone Number                                                                                     | 320     | <local>@<domain>                                                                             |
| Content            | The text contents of a message or announcement object                                                | String                                                                                                   | 10000   |                                                                                              |
| Date               | The date the a shift occurs                                                                          | Date                                                                                                     | 10      |                                                                                              |
| Direction          | A description of what steps are used to follow a recipe                                              | String                                                                                                   | 1000    |                                                                                              |
| Email              | An email address                                                                                     | String                                                                                                   | 320     | <local>@<domain>                                                                             |
| Employee           | Information about the individual who works at Banter Ice Cream                                       | Employee ID + Employee Name + Role + Contact + 1:2 {Location} + Banking Info ID + Username + Schedule ID |         |                                                                                              |
| Employee ID        | Unique identifier for an employee                                                                    | Integer                                                                                                  | 20      | system-generated sequential integer, beginning with 1                                        |
| Employee Name      | Name used to address an employee of Banter Ice Cream                                                 | String                                                                                                   | 128     |                                                                                              |
| End Time           | The date and time that a shift ends.                                                                 | DateTime                                                                                                 | 8 bytes |                                                                                              |
| File               | An attached file of an allowed file type (pdf, video, or image)                                      | File                                                                                                     | 20 MB   |                                                                                              |
| Ingredient         | Details of an ingredient used in a recipe                                                            | Ingredient ID + Name + Quantity + Quantity Units + Recipe ID                                             |         |                                                                                              |
| Ingredient ID      | Unique identifier for an ingredient                                                                  | Integer                                                                                                  | 20      | system-generated sequential integer, beginning with 1                                        |
| Ingredient Name    | A term used to identify an ingredient                                                                | String                                                                                                   | 32      |                                                                                              |
| Institution Number | A number representing the financial institution responsible for a given bank account                 | Integer                                                                                                  | 3       |                                                                                              |
...
| Message            | A message sent to one or employees at Banter Ice Cream.                                              | Message ID + Author + {1:n} Recipient + Content + 0:n {File} + Timestamp                                 |         |                                                                                              |
| Message ID         | Unique identifier for a message                                                                      | Integer                                                                                                  | 20      | system-generated sequential integer, beginning with 1                                        |
| Password           | A secure text that allows access to an account                                                       | String                                                                                                   | 20      |                                                                                              |
| Phone Number       | A phone number                                                                                       | Integer                                                                                                  | 10      |                                                                                              |
| Transit Number     | A number representing the institution branch responsible for a given bank account                    | Integer                                                                                                  | 5       |                                                                                              |
| Quantity           | The amount of an ingredient used in a recipe                                                         | Integer                                                                                                  | 2       | Positive number                                                                              |
| Quantity Units     | The units                                                                                            | String                                                                                                   | 20      | Standard baking units: cups, tablespoons, teaspoons, milliliters, liters, milligrams, grams  |
| Reaction           | A non-textual response to an announcement by an employee using an emoji                              | Reaction ID + Emoji ID + Employee ID + DateTime                                                          |         |                                                                                              |
| Recipe             | Instructions on how to make an Ice Cream Flavour.                                                    | Recipe Name + Author + isActive + {0:n} Allergen + {1:n} Ingredient + {1:n} Direction                    |         |                                                                                              |
| Recipient          | An employee who receives a message                                                                   | Employee ID                                                                                              |         |                                                                                              |
...
| Schedule           | The shifts currently assigned to an employee.                                                        | Employee ID  + {0:n} Shift ID + Author                                                                   |         |                                                                                              |
| Shift              | An assigned time for an employee to work at a given Banter Ice Cream branch location.                | Shift ID + Start Time + End Time + Date + Role + Location                                                |         |                                                                                              |
| Shift ID           | Unique identifier for a shift                                                                        | Integer                                                                                                  | 20      | system-generated sequential integer, beginning with 1                                        |
| Start Time         | The date time that a shift begins.                                                                   | DateTime                                                                                                 | 8 bytes |                                                                                              |
| Timestamp          | The date and time that the object was created.                                                       | DateTime                                                                                                 | 8 bytes |                                                                                              |
| User Account       |                                                                                                      | User ID + Employee ID + Username + Password                                                              |         |                                                                                              |
