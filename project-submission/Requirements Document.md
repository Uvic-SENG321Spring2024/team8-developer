...
<br><br> * It should cost less time for new employees to get onboard and learn how to correctly use the company software. <br><br> * Staff should not need to spend time on manual time tracking of employee sick hours or holidays. <br><br> * The number of understaffed hours should be decreased. Employees should record time that they feel the store is understaffed and customers should have the option to provide feedback on time they feel the store is understaffed. The understaffed time based on this feedback should decrease after the new system is fully implemented. <br>
