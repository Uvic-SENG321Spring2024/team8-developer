...
<br><br> * Having a unified system instead of having to rely on multiple apps mean it should cost less time for new employees to get onboard and learn how to correctly use the company software. <br><br> * Staff should not need to spend time on manual time tracking of employee sick hours or holidays as this will be automated, errors in payroll information should also be minimized since it will be automatic as well. <br><br> * The number of understaffed hours should be decreased. Employees should record time that they feel the store is understaffed and customers should have the option to provide feedback on time they feel the store is understaffed. The understaffed time based on this feedback should decrease after the new system is fully implemented. <br>
